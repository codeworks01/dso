...
// CONCATENATED MODULE: ./components/FlexibleContent.js


var Meta = card_default.a.Meta;

var FlexibleContent_Component = function Component() {
...
/* harmony default export */ var FlexibleContent = (FlexibleContent_Component);
...
var contentListNoTitle = {
  article: external_react_default.a.createElement("div", null, external_react_default.a.createElement("p", null, "The main objective of Tekton Pipelines is to run your Task individually or as a part of a Pipeline. Every task runs as a Pod on your Kubernetes cluster with each step as its own container."), external_react_default.a.createElement("ul", null, external_react_default.a.createElement("li", null, "A Task defines the work that needs to be executed, for example the following is a simple task that will echo hello world:"), external_react_default.a.createElement("li", null, "The steps are a series of commands to be sequentially executed by the task."))),
  app: external_react_default.a.createElement("div", null, external_react_default.a.createElement("ul", null, external_react_default.a.createElement("li", null, "A Task defines the work that needs to be executed, for example the following is a simple task that will echo hello world:"), external_react_default.a.createElement("li", null, "The steps are a series of commands to be sequentially executed by the task."))),
  project: external_react_default.a.createElement("div", null, external_react_default.a.createElement("p", null, "Zombie ipsum reversus ab viral inferno, nam rick grimes malum cerebro. De carne lumbering animata corpora quaeritis. Summus brains sit\u200B\u200B, morbo vel maleficia? De apocalypsi gorger omero undead survivor dictum mauris. Hi mindless mortuis soulless creaturas, "), external_react_default.a.createElement("ul", null, external_react_default.a.createElement("li", null, "A Task defines the work that needs to be executed, for example the following is a simple task that will echo hello world:"), external_react_default.a.createElement("li", null, "The steps are a series of commands to be sequentially executed by the task.")))
};
...
var Tekton_Tekton = function Tekton() {
  ...
  return external_react_default.a.createElement(row_default.a, {
    ...
    className: "p-4"
  }, external_react_default.a.createElement(FlexibleContent, null)), external_react_default.a.createElement(card_default.a, {
    title: "Tekton",
    bordered: false
    ...
    className: "p-4"
  }, external_react_default.a.createElement(Tabs, null)))));
};
